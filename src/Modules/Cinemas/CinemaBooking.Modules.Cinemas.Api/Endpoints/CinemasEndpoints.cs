...
namespace CinemaBooking.Modules.Cinemas.Api.Endpoints;
...
public static class CinemasEndpoints
{
    ...
    private static async Task<CreatedAtRoute> CreateCinema(
        CinemaDto data, 
        ICinemaService cinemaService,
        CancellationToken cancellationToken)
    {
        await cinemaService.CreateAsync(data, cancellationToken);
    ...
    private static async Task<NoContent> UpdateCinema(
        ...
        CancellationToken cancellationToken)
    {
        await cinemaService.UpdateAsync(data, cancellationToken);
